# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/09_custompropertymanager.ipynb.

# %% auto 0
__all__ = ['CustomPropertyManager']

# %% ../nbs/09_custompropertymanager.ipynb 1
...
from SolidPy.enums.enum_results import (
    CustomInfoAddResult,
