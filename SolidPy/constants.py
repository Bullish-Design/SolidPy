# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/constants/constants.ipynb.

# %% auto 0
__all__ = ['swConst', 'swCmd', 'arg1', 'var1', 'varVals', 'varBool', 'varNone', 'Empty', 'newDrw']

# %% ../nbs/constants/constants.ipynb 1
